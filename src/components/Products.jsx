...
const projects = [
  {
    ...
    image: netflix,
    url: "https://profile-three-azure.vercel.app/" // file:/// waale URL kaam nahi karte
  },
  {
    index: 2,
    name: "Spotify Website Clone",
    image: spotify,
    url: "https://profile-three-azure.vercel.app/"
  },
  {
    index: 3,
      ...
      {projects.map((project, index) => (
        <div key={index} className='bg-black rounded-xl w-full max-w-[370px] overflow-hidden shadow-lg'>
          ...
          <div className='text-center pb-4'>
            <button
              className='bg-blue-500 px-4 py-2 rounded-full text-white font-bold hover:bg-blue-600 transition'
              onClick={() => handleIframeToggle(project.url)}
            >
              View Demo
            </button>
          </div>
